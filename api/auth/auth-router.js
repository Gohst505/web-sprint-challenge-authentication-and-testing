...
const {BCRYPT_ROUNDS, JWT_SECRET} = require('../../index'); //which file do I refer to for these to values
const {checkUserIsValid, checkUsernameFree} = require('../middleware/auth-middleware');
